...
/* harmony import */ var _modules_postStore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/postStore */ "./resources/js/store/modules/postStore.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new vuex__WEBPACK_IMPORTED_MODULE_2__["default"].Store({
  modules: {
    postStore: _modules_postStore__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  state: {},
  mutations: {},
  actions: {}
...
/***/ "./resources/js/store/modules/postStore.js":
/*!*************************************************!*\
  !*** ./resources/js/store/modules/postStore.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mutations: {
    ...
    ADD_POST: function ADD_POST(state, postPayload) {
      state.posts.push(postPayload);
    }
  },
  actions: {
    storePost: function storePost(_ref, postPayload) {
      var commit = _ref.commit;
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('', postPayload).then(function (response) {
        return response.data;
      }).then(function (respose) {
        commit('ADD_POST', respose.data);
      });
    },
    updatePost: function updatePost(_ref2, postPayload) {
      var commit = _ref2.commit;
      axios__WEBPACK_IMPORTED_MODULE_0___default().put('', postPayload).then(function (response) {
        return response.data;
...
var map = {
	...
	"./PostForm": [
		...
		"resources_js_Pages_PostForm_vue"
	],
	"./PostForm.vue": [
		"./resources/js/Pages/PostForm.vue",
		"resources_js_Pages_PostForm_vue"
	...
	"./PostIndex": [
		...
		"resources_js_Pages_PostIndex_vue"
	],
	"./PostIndex.vue": [
		"./resources/js/Pages/PostIndex.vue",
		"resources_js_Pages_PostIndex_vue"
...
/******/ 			if ({"resources_js_Pages_Post_vue":1,"resources_js_Pages_PostForm_vue":1,"resources_js_Pages_PostIndex_vue":1}[chunkId]) return "js/" + chunkId + ".js";
